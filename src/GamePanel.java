...
public class GamePanel extends JPanel implements Inputs.Listener {
    ...
    private void Initialise() {
        ...
        textX = (int) (Game.WIDTH - Game.WIDTH * 0.30); // subtracting 20% from the gameboard width
    ...
    private void initClasses() {
        ...
        FontMetrics fontMetrics = getFontMetrics(Game.FONT);
        /* Buttons */
        btnPlay = new Button(this, "PLAY", new Point(textX, textY), fontMetrics);
        btnOptions = new Button(this, "OPTIONS", new Point(textX, textY + 80), fontMetrics);
        btnExit = new Button(this, "EXIT", new Point(textX, textY + 160), fontMetrics);

        /* Options menu */
        btnBack = new Button(this, "<< BACK", new Point(textX - 120, textY), fontMetrics);
        btnSound = new Button(this, "SOUND", new Point(textX - 100, textY + 80), fontMetrics);
        Point ptMusicOn = new Point(textX - 80 + btnSound.getWidth(), textY + 80);
        btnMusicOn = new Button(this, "<", ptMusicOn, fontMetrics);
        btnMusic = new Button(this, "ON", new Point(btnMusicOn.getCoordinates().x + 40,
                btnMusicOn.getCoordinates().y), fontMetrics);
        btnMusicOff = new Button(this, ">", new Point(btnMusic.getCoordinates().x + 80,
                btnMusic.getCoordinates().y), fontMetrics);
    ...
    private void moveDino() {
        if (dinoY <= 300) dinoY = Dino.Y_COORDINATE;
